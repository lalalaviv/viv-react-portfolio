...
const initializeLocalStorage = () =>{
    let tree = localStorage.getItem('vivian-files');
    if(tree !== null)
        return
...
const saveData = (tree) => {
    ...
    localStorage.setItem('vivian-files',stringFileStructure)
}
...
export default class OS extends React.Component{
    ...
    terminalString = this.user + 'vivian:~$ '


    constructor(props){
        super(props)
        initializeLocalStorage();
        this.tree = JSON.parse(localStorage.getItem('vivian-files'))
